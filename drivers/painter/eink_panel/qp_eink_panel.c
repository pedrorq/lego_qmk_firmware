...
// TODO: May not store any info about RAM/partial, and provide another driver
// for those, as this code makes little sense on them
...
bool qp_eink_panel_clear(painter_device_t device) {
    ...
    // Init the surfaces being wrapped
...
bool qp_eink_panel_convert_eink_3c(painter_device_t device, int16_t palette_size, qp_pixel_t *palette) {
    struct eink_panel_dc_reset_painter_device_t *driver = (struct eink_panel_dc_reset_painter_device_t *)device;
