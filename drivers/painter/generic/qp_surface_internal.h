...
typedef struct surface_painter_device_t {
    ...
    bool transpose_xy; // Whether or not to swap the x/y coordinates during write
...
void qp_surface_rotate_xy(painter_rotation_t rotation, uint16_t width, uint16_t height, uint16_t *x, uint16_t *y);
