...
#ifdef QUANTUM_PAINTER_ILI9486_SHIFTREG_SPI_ENABLE
#    include <qp_comms_spi.h>
#endif // QUANTUM_PAINTER_ILI9486_SHIFTREG_SPI_ENABLE

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Common

// Driver storage
tft_panel_dc_reset_painter_device_t ili9486_shiftreg_drivers[ILI9486_SHIFTREG_NUM_DEVICES] = {0};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Initialization

bool qp_ili9486_shiftreg_init(painter_device_t device, painter_rotation_t rotation) {
    // clang-format off
    const uint8_t ili9486_shiftreg_init_sequence[] = {
    ...
    // clang-format on
    qp_comms_bulk_command_sequence(device, ili9486_shiftreg_init_sequence, sizeof(ili9486_shiftreg_init_sequence));
...
const struct tft_panel_dc_reset_painter_driver_vtable_t ili9486_shiftreg_driver_vtable = {
    .base =
        {
            .init            = qp_ili9486_shiftreg_init,
...
// Factory function for creating a handle to the ILI9486 device with SPI->Parallel shift register converter
painter_device_t qp_ili9486_shiftreg_make_spi_device(uint16_t panel_width, uint16_t panel_height, pin_t chip_select_pin, pin_t dc_pin, pin_t reset_pin, uint16_t spi_divisor, int spi_mode) {
    for (uint32_t i = 0; i < ILI9486_NUM_DEVICES; ++i) {
        tft_panel_dc_reset_painter_device_t *driver = &ili9486_shiftreg_drivers[i];
        if (!driver->base.driver_vtable) {
            driver->base.driver_vtable         = (const struct painter_driver_vtable_t *)&ili9486_shiftreg_driver_vtable;
