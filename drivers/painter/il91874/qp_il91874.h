...
// Maximum buffer that the controler chip could need (320 * 300 * 2 / 8)
#define IL91874_MAX_BUFFER_SIZE 24000
...
#    pragma message "Increased your QUANTUM_PAINTER_PIXDATA_BUFFER_SIZE to: " STR(IL91874_MAX_BUFFER_SIZE)
#endif
