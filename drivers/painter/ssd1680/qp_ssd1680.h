...
#define SSD1680_MAX_BUFFER_SIZE (176 * 296 * 2 / 8)
...
#    pragma message "Increased your QUANTUM_PAINTER_PIXDATA_BUFFER_SIZE to `" STR(SSD1680_MAX_BUFFER_SIZE) "` so code can work correctly"
#endif
