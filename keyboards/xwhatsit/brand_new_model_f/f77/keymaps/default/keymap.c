...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
        ...
        KC_CAPS, KC_LGUI, KC_LALT,                      KC_SPC,           KC_NO, KC_RALT, KC_NUM, KC_RCTL,      KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    [_FN] = LAYOUT_all(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8,   KC_F9, KC_F10,    KC_F11, KC_F12, KC_INS, KC_DEL,           KC_HOME,   KC_UP,   KC_PGUP,
        KC_NO,      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SCRL , KC_PAUS, KC_UP, KC_NO, KC_DEL,                 KC_LEFT,   KC_NO,   KC_RIGHT,
    ...
    [_FN2] = LAYOUT_all(
        ...
        _______,     _______, _______, EE_CLR, QK_RBT, QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______,     _______, _______, _______,
